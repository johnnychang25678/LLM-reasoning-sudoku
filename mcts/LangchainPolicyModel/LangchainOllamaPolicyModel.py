...
from mcts.LangchainPolicyModel.prompts import (
    gen_actions_prompt,
    is_terminal_prompt,
    is_terminal_and_give_reward_prompt,
    GenerateActionsResponse,
    TerminalStateResponse,
    TerminalStateRewardResponse,
    get_actions_chain,
    get_terminal_chain,
...
class LangChainSudokuPolicyModel:
    def __init__(self, model_name="llama3.1:70b-instruct-q4_0", callback_handler=None):
        ...
        self.actions_chain = get_actions_chain(self.llm)
        self.terminal_chain = get_terminal_chain(self.llm)
        self.terminal_reward_chain = get_terminal_reward_chain(self.llm)
